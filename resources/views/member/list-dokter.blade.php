...
<style>
    ...
    .doctor-name { font-weight: 600; color: #2c3e50; display: block; }
    .specialist-badge {
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <small class="text-muted"><i class="bi bi-briefcase me-1"></i> {{ $doctor->experience_years }} Pengalaman</small>
                    </td>
                    <td>
                    ...
                    <td class="text-center">
                        <a href="{{ route('doctors.show', $doctor->id) }}" class="btn btn-primary btn-sm btn-action">
                            Lihat Detail
                        </a>
                    </td>
                </tr>
