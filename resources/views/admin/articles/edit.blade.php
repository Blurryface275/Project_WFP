                ...
                <div class="card-body">
                    <form action="{{ route('admin.articles.update', $article->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            @if($article->photo)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $article->photo) }}" width="150" alt="Foto artikel saat ini" class="img-thumbnail">
                                    <small class="d-block text-muted">Foto saat ini. Upload foto baru untuk mengganti.</small>
                                </div>
                            @endif
