...
@section('content-admin')
    <div class="container-fluid">
        ...
        <div class="mb-3 text-right">
            <button type="button" class="btn btn-warning" data-coreui-toggle="modal" data-coreui-target="#btnFormModal">
                        ...
                        <tr id="tr_{{$doctor->id}}">
                            ...
                            <td>
                                <button type="button" class="btn btn-warning btn-sm" data-coreui-toggle="modal"
                                    data-coreui-target="#modalEditA" onclick="getEditForm({{ $doctor->id }})">
                                    Edit
                                </button>
