        ...
        <div class="row align-items-center">
          <div class="col-lg-6">
            <ul class="top-bar-info list-inline-item pl-0 mb-0">
              <li class="list-inline-item"><a href="mailto:support@klinik.com"><i
                    class="icofont-support-faq mr-2"></i>support@klinik.com</a></li>
        ...
        <div class="collapse navbar-collapse" id="navbarmain">
          ...
          @if(isset($isAdmin) && $isAdmin)
            <ul class="navbar-nav ml-auto d-flex align-items-center"
              style="border-left: 2px solid #e2e2e2; padding-left: 15px;">
              <li class="nav-item {{ request()->routeIs('admin.users') ? 'active' : '' }}">
                <a class="nav-link text-primary font-weight-bold" href="{{ route('admin.users') }}">Kelola User</a>
              </li>
              <li class="nav-item {{ request()->routeIs('admin.doctors') ? 'active' : '' }}">
                <a class="nav-link text-primary font-weight-bold" href="{{ route('admin.doctors') }}">Kelola Dokter</a>
              </li>
              <li class="nav-item {{ request()->routeIs('admin.articles') ? 'active' : '' }}">
                <a class="nav-link text-primary font-weight-bold" href="{{ route('admin.articles') }}">Kelola Artikel</a>
              </li>
              <li class="nav-item {{ request()->routeIs('admin.categories') ? 'active' : '' }}">
                <a class="nav-link text-primary font-weight-bold" href="{{ route('admin.categories') }}">Kelola Categories</a>
              </li>
            </ul>
          @endif
        </div>
